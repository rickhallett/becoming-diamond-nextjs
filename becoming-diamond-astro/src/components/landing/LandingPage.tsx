        ...
        <main className="bg-black min-h-screen text-white overflow-hidden">
            ...
            <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? "bg-black/80 backdrop-blur-sm py-4" : "bg-transparent py-6"}`}>
                <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                    <a href="/" className="text-xl font-thin tracking-wider">
                        BECOMING DIAMOND
                    </a>
            ...
            <section className="min-h-screen flex items-center justify-center relative">
                ...
                >
                    ...
                    <h1 className="mb-8 leading-none text-4xl md:text-6xl font-bold">
            ...
            <section className="py-24 px-6 bg-black relative">
                <div className="max-w-7xl mx-auto w-full relative">
                    ...
                    >
                        <h2 className="text-center mb-4 text-3xl md:text-5xl font-bold">
            ...
            <section id="problem" className="py-24 px-6 bg-gradient-to-b from-black via-secondary/30 to-black relative">
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    >
                        <h2 className="mb-6 text-3xl md:text-5xl font-bold">The <span className="text-primary">Pressure</span> You're Under<br />Isn't the Problem</h2>
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-black via-secondary/50 to-black">
                <div className="max-w-6xl mx-auto">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="mb-6 text-3xl md:text-5xl font-bold">What People Are Saying</h2>
            ...
            <section className="py-24 px-6 relative overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-6 relative z-10 pt-16 pb-24">
                    <motion.div
                        ...
                        className="text-center mb-12"
                    >
                        <h3 className="text-3xl mb-4">Your Transformation Journey</h3>
                        ...
                        data={[
                            {
                                ...
                                content: (
                                    <div>
                                        <h4 className="text-2xl font-normal text-primary mb-4">Stabilize</h4>
                            ...
                            },
                            {
                                ...
                                content: (
                                    <div>
                                        <h4 className="text-2xl font-normal text-primary mb-4">Shift</h4>
                                        <p className="mb-4 text-sm md:text-base text-gray-300">
                            ...
                            },
                            {
                                ...
                                content: (
                                    <div>
                                        <h4 className="text-2xl font-normal text-primary mb-4">Strengthen</h4>
                                        <p className="mb-4 text-sm md:text-base text-gray-300">
                            ...
                            },
                            {
                                ...
                                content: (
                                    <div>
                                        <h4 className="text-2xl font-normal text-primary mb-4">Shine</h4>
                                        <p className="mb-4 text-sm md:text-base text-gray-300">
                            ...
                            },
                            {
                                ...
                                content: (
                                    <div>
                                        <h4 className="text-2xl font-normal text-primary mb-4">Synthesize</h4>
                                        <p className="mb-4 text-sm md:text-base text-gray-300">
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-black via-secondary/50 to-black">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="mb-8 text-3xl md:text-5xl font-bold">
            ...
            <section className="py-24 px-6 bg-gradient-to-b from-black via-secondary/30 to-black">
                <div className="max-w-6xl mx-auto">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="mb-6 text-3xl md:text-5xl font-bold">Contact Us</h2>
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
