    ...
    return (
        <MemberAreaTransition>
            {({ startTransition }) => (
                ...
                socialProof={{
                    stat: "Over 2,000 professionals increased their income by an average of 2x in just 5 days",
            ...
            <section className="py-24 px-6 bg-black relative">
                <div className="max-w-7xl mx-auto w-full relative">
                    ...
                    <div className="flex justify-center w-full">
                        <div className="relative overflow-hidden w-full md:w-[700px] md:h-[700px] h-[500px] max-w-full">
